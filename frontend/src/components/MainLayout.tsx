        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-gray-50">
                <div className="text-center">
                    <div
                        className="w-16 h-16 border-4 border-[#01D8B6] border-t-transparent rounded-full animate-spin mx-auto mb-4"></div>
            ...
            <div className={`relative z-10 transition-all duration-300 ${isExpanded ? 'pt-24' : 'pt-[30vh]'}`}>
                ...
                <div className="bg-gradient-to-b from-gray-50 to-transparent pb-6 z-20">
                    <div className="flex flex-col items-center">
                        ...
                        >
                            <div
                                className="w-20 h-20 bg-gradient-to-tr from-[#01D8B6] to-[#00f5d4] rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg shadow-[#01D8B6]/20">
